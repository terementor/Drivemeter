...
import com.github.terementor.drivemeter.activity.ConfigActivity;
import com.github.terementor.drivemeter.activity.MainActivity;
import com.github.terementor.drivemeter.io.ObdCommandJob.ObdCommandJobState;
...
public class ObdGatewayService extends AbstractGatewayService {
    ...
    public void startService() throws IOException {
        ...
        Log.d("bluetoothdevicestring", remoteDevice);
        if (remoteDevice == null || "".equals(remoteDevice)) {
            ...
            Log.d("bluetoothdevice", dev.toString());
